...
const remotesMap = {
'remoteReact':{url:'http://localhost:5001/assets/remoteEntry.js',format:'esm',from:'vite'},
  'remoteVue':{url:'http://localhost:5002/assets/remoteEntry.js',format:'esm',from:'vite'}
};
...
const {lazy,Suspense} = React$1;

const RemoteButton = lazy(() => __federation_method_getRemote("remoteReact" , "./Button").then(module=>__federation_method_wrapDefault(module, true)));
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "40px", fontFamily: "Arial, sans-serif" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { style: { textAlign: "center", color: "#333" }, children: "🚀 Host App - Module Federation" }),
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: { color: "#1e40af" }, children: "📦 React Remote Component" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#64748b" }, children: "From: http://localhost:5001" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Loading..." }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(RemoteButton, {}) })
            ]
          }
        )
      }
