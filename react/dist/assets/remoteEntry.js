...
"./Button":()=>{
      ...
      return __federation_import('./__federation_expose_Button-BRrZzX-o.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
        ...
        cssFilePaths.forEach(cssPath => {
         ...
         if (baseUrl) {
          ...
          if (dontAppendStylesToHead) {
            const key = 'css__remoteReact__' + exposeItemName;
